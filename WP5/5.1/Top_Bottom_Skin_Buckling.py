...
critical_bottom_stresses_function = interp1d(spanwise_location_stress, bottom_stress_list, kind="linear", fill_value="extrapolate")
critical_top_stresses_function = interp1d(spanwise_location_stress, top_stress_list, kind="linear", fill_value="extrapolate")

"""
# print statements if needed to test code
